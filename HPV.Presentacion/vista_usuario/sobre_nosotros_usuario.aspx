<%@ Page Title="" Language="C#" MasterPageFile="~/base.Master" AutoEventWireup="true" CodeBehind="sobre_nosotros_usuario.aspx.cs" Inherits="HPV.Presentacion.vista_usuario.sobre_nosotros_usuario" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphReservationForm" runat="server">
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphCenter" runat="server">
    <div class="main_bg">
        <div class="container">
            <div class="main">
                <div class="details">
                        <h2 id="titulo">Hotel Puerto Viejo</h2>    
                    <div class="det_pic">
                        <img src="images/det_pic.jpg" alt="" />
                    </div>
                    <div class="det_text">
                        <p class="para" id="descripcion"> 
                            Hotel Puerto Viejo esta localizado en las playas del Océano Atlántico de la provincia de Limón y posee una 
                            playa paradisíaca para los amantes del mar. Dentro de una exótica flora y fauna se encuentra un pueblo costero 
                            con unas playas maravillosas de agua azul cristalina y con sorprendentes oportunidades para el surfing. 
                            Rápidamente se ha convertido en uno de los primeros puntos turísticos calientes de Costa Rica, muchos sufistas 
                            internacionales de todo el mundo vienen a las famosas olas de Salsa Brava, haciendo de este pueblo Caribe el sitio 
                            “mas visitado” en Limón. Es conocido simplemente como Puerto Viejo por los locales y no debe confundirse con Puerto 
                            Viejo de Sarapiqui en Heredia. Este activo pueblo esta a 34 millas al sureste de Puerto Limón y a 102 millas al sur 
                            de Cahuita. Puerto Viejo con su encanto único era antiguamente un caserío pequeño y tranquilo de pescadores. 
                        </p>
                    </div>
                </div>
            </div>
